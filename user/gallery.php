        ...
        <div class="container">
            <div class="cta-content">
                ...
                <div class="cta-buttons">
                    <a href="../user/booking.php" class="btn btn-primary btn-large">Book Your Event</a>
                    <a href="../user/about.php" class="btn btn-secondary btn-large">Learn More About Us</a>
                </div>
            </div>
        </div>
    </section>
